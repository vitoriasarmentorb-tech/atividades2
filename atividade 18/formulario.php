...
<body>
    ...
    <form action="./salvar _cliente.php" method="post">
    ...
    <h1>Formulário</h1>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="exampleInputEmail1" name="idade">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="tell" class="form-control" id="exampleInputEmail1" name="telefone">
